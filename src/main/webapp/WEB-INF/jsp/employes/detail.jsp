        ...
        <form id="saveForm" action="" method="post">
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <input type="text" value="${employe.matricule}" class="form-control" name="matricule"
                           id="matricule">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" value="${employe.salaire}" class="form-control" name="salaire"
                               id="salaire">
                    ...
                    <div class="input-group">
                        <input type="text" value="${employe.getPrimeAnnuelle()}" class="form-control"
                               name="primeAnnuelle" id="primeAnnuelle">
                        <span class="input-group-addon">€</span>
                    </div>
                    <% } %>

                    <label class="form-control-label" for="nom">Date d'embauche</label>
                    <input type="text" value="${employe.getDateEmbauche()}" class="form-control" name="dateEmbauche"
                           id="dateEmbauche">

                    <% if (emp instanceof Commercial && emp.getId() != null) { %>
                        ...
                        <div class="col-lg-10">
                            <c:forEach var="tech" items="${employe.equipe}">
                                <li class="list-group-item">
                                    <a href="${tech.id}">${tech.nom} ${tech.prenom}
                                        <span class="badge pull-right">${tech.matricule}</span></a>
                                </li>
                            </c:forEach>
                        </div>
                        <div class="col-lg-2 text-center">
                            <div class="list-group text-center">
                                <li class="list-group-item"><a href=""><span class="glyphicon glyphicon-remove"></span></a>
                                </li>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-6">
            ...
            <form action="" method="get">
                <div class="col-lg-10">
                    <input type="text" name="matricule" value=""
                           placeholder="Ajouter un technicien avec le matricule..." class="form-control">
                </div>
                <div class="col-lg-2 text-center">
            ...
            <div class="row">
                ...
                <form action="" method="get">
                    <div class="col-lg-10">
                        <input type="text" name="matricule" value=""
                               placeholder="Ajouter un manager avec le matricule..." class="form-control">
                    </div>
                    <div class="col-lg-2 text-center">
                        <button type="submit" class="btn-success list-group-item list-group-item-action"><span
                                class="glyphicon glyphicon-plus"></span></button>
